            ...
            do
            {
                do
                {
                    try
                    {
                        ...
                        dayofbearth = Math.Abs(Convert.ToInt32(Console.ReadLine()));
                        Console.WriteLine("Введите месяц своего рождения");
                        monthofbearth = Math.Abs(Convert.ToInt32(Console.ReadLine()));
                        Console.WriteLine("Введите год своего рождения");
                        yearofbearth = Math.Abs(Convert.ToInt32(Console.ReadLine()));
                        break;
                    }
                    catch (Exception)
                    {
                ...
                if (DateTime.IsLeapYear(yearofbearth) && monthofbearth == 2)
                {
                    ++months[1];
                }
                if (monthofbearth < 13 && monthofbearth > 0 && dayofbearth > 0 && dayofbearth < months[monthofbearth - 1] + 1 && yearofbearth < year && yearofbearth > 1850)
                {
                    break;
                }
                else
